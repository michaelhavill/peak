  ...
  return (
    <section className="py-24 md:py-32 px-8 md:px-16 lg:px-20" style={{ borderTop: "1px solid var(--border-subtle)" }}>
      <motion.div ref={ref} initial={{ opacity: 0, y: 20 }} animate={isInView ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.6 }} className="max-w-3xl">
        <h2 className="text-[42px] md:text-[56px] leading-[1.05] mb-6" style={{ fontFamily: "var(--font-instrument-serif)", color: "var(--text-primary)" }}>The 99% are being commoditized.{" "}<span style={{ color: "var(--text-secondary)" }}>Build your moat.</span></h2>
        <p className="text-[16px] leading-relaxed mb-10" style={{ color: "var(--text-secondary)" }}>Your taste, your craft, your domain knowledge — encoded into an AI stack no one else can replicate. This is how you become irreplaceable for your career and every company you touch.</p>
