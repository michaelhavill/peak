...
export const LEARN_PATHS = [
  ...
  },
  {
    ...
    description: "When AI understands your craft, taste, and knowledge, it stops drafting and starts collaborating. That's the shift from AI-as-tool to AI-as-peer - and it's where the real compounding happens.",
