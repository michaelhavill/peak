...
export const HUNTER_BANK: Entry[] = [
  ...
  { w: "thought", l: 1, p: "ought words", s: "Nate thought the test was next week. It was today.", h: "The past of think. Not the one that means to have given a lesson.", d: "ought", t: "The OUGHT gang: thOUGHT, bOUGHT, brOUGHT. Learn OUGHT once and you own the whole gang." },
  ...
  { w: "through", l: 2, p: "ought words", s: "The paper plane sailed through the open door. Into Mrs. Godfrey.", h: "The one that means from one side to the other, like going through a door. Not the one that means very careful, and not the past of throw.", d: "ough", t: "THR + OUGH: the OUGH gang making an OO sound this time. Same gang, new disguise." },
  ...
  { w: "licence", l: 3, p: "c and s sounds", s: "Ellen earned her driver's licence on the fourth attempt. Nate walks everywhere now.", h: "The official permit you hold, spelled the noun way. Not the verb.", d: "cence", t: "The noun ends in -CE: li-CEN-CE, like advICE. You would give Ellen advice about her licence. License with an S is only the verb." },
