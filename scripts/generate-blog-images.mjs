...
const POST_PROMPTS = {
  ...
  "widen-your-context-window": {
    ...
    sections: [
      ...
      "deep navy accent - a figure at the centre of a constellation of glowing orbiting spheres, each sphere a distinct colour and abstract shape representing a different field of knowledge, all connected by fine threads to the central figure who synthesizes them into one coherent view, the constellation beautiful and balanced, the synthesis visible as a warm glow at the centre, purely abstract visual symbols on the spheres with no words or letters of any kind",
    ],
  },
